...
The main contributor to tunnelled traffic was Teredo with an occurrence of nearly 89\,\% followed by 6to4 with over 11\,\%; therefore the relative amount of 6to4 traffic has increased. We then detected the use of 13 Teredo servers compared to 53 today. %The complete list of the detected servers can be downloaded at the project web page~\cite{web}. 
