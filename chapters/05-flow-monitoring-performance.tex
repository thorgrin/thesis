...
% nCAP, PF_RING DNA - exclusive access, specific drivers, worked only with some intel cards
% https://www.ntop.org/pf_ring/introducing-pf_ring-dna-direct-nic-access/
