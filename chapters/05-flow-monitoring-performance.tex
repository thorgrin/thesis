...
\begin{itemize}
  ...
  \item Section~
  \item Section~
  \item Section~\ref{sec:perf-summary} summarizes the chapter.
\end{itemize}
...
% TODO consider a background section
\section{How to Measure Flow Monitoring Performance}
...
\section{Hardware Acceleration in Flow Monitoring}
