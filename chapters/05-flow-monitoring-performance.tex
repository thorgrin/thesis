...
\itodo{(06:50:31 PM) Tomas Konir: jo a jeste jedna vec. videl jsem tam takovou drobnost. kde popisujes jak se paket zpracovava a ze je fajn kdyz se vleze do CPU cache\\
(06:51:27 PM) Tomas Konir: hodilo by se k tomu doplnit, ze z omezenych prostredku to nezere jen CPU instrukce, ale taky propustnost pameti, protoze kazdy ten paket se do te cache nejdrivmusi nekudy dostat. }
...
\itodo{https://wiki.linuxfoundation.org/networking/kernel\_flow dneska karty pisou primo do sk_buff pres DMA transfery, driv se to kopirovalo zvlast\\
je potreba to popsat a zmenit i obrazek. \\
vypada to, ze i do MMAP se kopiruje ze sk_buffu, ale vyhoda je, ze se setri syscally. je potreba v tomhle smyslu upravit text}
