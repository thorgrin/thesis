...
\end{equation*}
We denote $\mathbb{S}_k$ the set of indexes in $\widehat{\mathcal{P}}_k$.\improve{do we need sequential indexes?}

\itodo{
Protože pak bys nemusel říkat, že do toku přidáš packet s indexem wtf, kde wtf je nejmenší číslo z $S\_k$ takové, že... Rovnou bys definoval induktivně tu množinu indexů a tok jako posloupnost jdoucí přes tuto indexovou množinu, což vypadá hezky...
}
