...
\begin{description}
	...
	\item[Mirrored mode] -- In the mirrored mode, a copy of network traffic is created and delivered to the probe using dedicated link. The copy can be created either by dedicated TAP (Test Access Point) or an active networking device with the use of a SPAN (Switch Port Analyzer) port.
	\begin{description}
	...
	\end{description}
	Table~\ref{tab:tap_vs_span} shows differences, advantages, and disadvantages of TAP and SPAN solutions.
\end{description}
...
\itodo{
- picture of deployment with switch and TAP
...
The location of active networking devices is given by the function they perform. However, 
