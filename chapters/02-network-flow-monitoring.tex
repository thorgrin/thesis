...
In order to provide the most complete definition of flow, we must address all the above mentioned issues. The most direct solution is to start with the NetFlow v9 definition and allow non-IP packets. Therefore, the definition used in this thesis is as follows:

\begin{displayquote}

    An Flow is defined as a set of packets passing an Observation Point
    ...
    the data contained in the packet and from the packet treatment
    at the Observation Point.
   
\end{displayquote}

\itodo{Flow expiration/termination vs app flow splitting}
