...
\itodo{
- Discuss implementation of the flow selection function\\
- Flow metering (caches, ...), biflows\\
- Flow expiration/termination \\
- mention that database of all flow records and termination/expiration is mentioned in rfc5470
}
...
\itodo{mention that the fragmentation is the most significant reason for working with a whole history of packets in flow definition - flow keys cannot always be derived from the single packet}
