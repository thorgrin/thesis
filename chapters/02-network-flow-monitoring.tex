...
The Figure~\ref{fig:ipfix-reference-model} shows various scenarios of flow monitoring architecture as defined by IPFIX working group. 
\begin{itemize}
	\item Modularity of ipfix device/exporter
	\item Modularity of data processing (at collector vs elsewhere). Describe how we send data to stream for flow.
\end{itemize}


\itodo{prekreslit Figure 1 z rfc5470}
