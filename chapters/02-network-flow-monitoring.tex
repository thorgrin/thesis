...
% jeden odstavec o cem to je, na konci se vymezit k rickovi
...
\begin{itemize}
  ...
  \item Section~\ref{sec:flow-monitoring-architecture} 
  \item Section~\ref{sec:flow-monitoring-process} 
  \item Section~\ref{sec:flow-data-processing} 
  \item Section~\ref{sec:common-issues} discusses common issues in encountered in flow monitoring operation.
