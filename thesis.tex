...
The Internet has become a crucial medium for business, entertainment, communication, learning, access to information, and other human endeavours. As the society becomes increasingly dependent upon the availability and security of online services, the revenue from disrupting the normal operation of these service increases as well. Gaining unauthorized access, disrupting functionality, stealing and selling confidential data, and impersonation are only a few examples of these disruptions. Various methods, such as firewalls and anti-virus software, are intended to thwart such attacks and reduce the associated risks. To protect users on their networks, network administrators often deploy network monitoring systems to detect and mitigate the threats.
